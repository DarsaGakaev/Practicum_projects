...
| [Проект "Классификация комментариев"](tf_idf) | Разработка модели для классификации комментариев на позитивные и негативные| WordNetLemmatizer, TfidfVectorizer |
