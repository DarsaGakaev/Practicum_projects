...
| [Проект "Классификация комментариев"](milking_cows) | Разработка модели для классификации комментариев на позитивные и негативные| WordNetLemmatizer, TfidfVectorizer |
