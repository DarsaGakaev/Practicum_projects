...
| [Проект "Классификация комментариев"](tf-idf/tf-idf.ipynb) | Разработка модели для классификации комментариев на позитивные и негативные| WordNetLemmatizer, TfidfVectorizer |
